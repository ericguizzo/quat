...
parser.add_argument('--model_path', type=str, default='../beta_exp/experiment_10_simple_autoencoder.txt/models/model_xval_iemocap_exp10_simple_autoencoder.txt_run1_fold0')
