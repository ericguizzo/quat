...
parser.add_argument('--model_path', type=str, default='../beta_exp/experiment_7_beta_vanilla_newloss_real.txt/models/model_xval_iemocap_exp7_beta_vanilla_newloss_real.txt_run1_fold0')
