...
parser.add_argument('--model_path', type=str, default='../beta_exp/experiment_4_beta_vgg_higherbatch.txt/models/model_xval_iemocap_exp4_beta_vgg_higherbatch.txt_run6_fold0')
