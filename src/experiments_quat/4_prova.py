...
global_parameters = {'experiment_description': 'test experiment',
                     'dataset': 'iemocap',
                     'num_experiment': 0,
                     'num_folds': 1,
                     'num_epochs': 3,
...
experiment[1] = {'comment_1': "prova1",
                 'comment_2': "prova1"
                 }
experiment[2] = {'comment_1': "prova2",
                 'comment_2': "prova2"
                 }
      ...
      "1":{
          "comment_1": "prova1", "comment_2": "prova1"
          },

      "2":{
          "comment_1": "prova2", "comment_2": "prova2"
              }
