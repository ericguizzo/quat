...
global_parameters = ['output_classes=3',
                     'batch_size=30',
                     'architecture="vgg16"',
...
experiment[3] = ['comment_1="prova3"', 'comment_2="blablabla"'
                 ]

experiment[4] = ['comment_1="prova4"', 'comment_2="blablablabla"'
                 ]

experiment[5] = ['comment_1="prova5"', 'comment_2="blablablablabla"'
                 ]
