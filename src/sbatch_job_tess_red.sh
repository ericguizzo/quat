...
#SBATCH --job-name=quat_3                 # Job name
...
#SBATCH --output=experiment_quat_3_%j.out        # Standard output and error log [%j is replaced with the jobid]
#SBATCH --error=experiment_quat_3_%j.error
#SBATCH --gres=gpu:1
