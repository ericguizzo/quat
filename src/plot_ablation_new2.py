...
fig, ax = plt.subplots()
rects1 = ax.barh(x, y, width, label='RH-emo variants')
...
ax.set_title('Ablation Study: removing RH-emo components')
ax.set_yticks(x)
ax.set_yticklabels(labels)

ax.set_xlim(-13,0.5)

plt.axvline(x=0, color='black', label='Baseline: Full RH-emo')
ax.legend()
