...
#SBATCH --job-name=quat_1                 # Job name
...
#SBATCH --output=experiment_quat_1_%j.out        # Standard output and error log [%j is replaced with the jobid]
#SBATCH --error=experiment_quat_1_%j.error
#SBATCH --gres=gpu:1
